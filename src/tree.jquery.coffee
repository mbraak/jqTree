...
class JqTreeWidget extends MouseWidget
    defaults:
        ...
        autoEscape: true
        dataUrl: null
        closedIcon: String.fromCharCode(0x25ba) # '&#x25ba;'  # The symbol to use for a closed node - ► BLACK RIGHT-POINTING POINTER  http://www.fileformat.info/info/unicode/char/25ba/index.htm
        openedIcon: String.fromCharCode(0x25bc) # '&#x25bc;'  # The symbol to use for an open node - ▼ BLACK DOWN-POINTING TRIANGLE  http://www.fileformat.info/info/unicode/char/25bc/index.htm
