...
var jqtree = (function (exports) {
    ...
    _createClass(VisibleNodeIterator, [{
      ...
      value: function iterate() {
        ...
        var _iterateNode = function _iterateNode(node, nextNode) {
          ...
          if ((_node$element = node.element) !== null && _node$element !== void 0 && _node$element.offsetParent) {
            ...
            if (!node.hasChildren()) {
              _this.handleNode(node, nextNode, node.element);
            } else if (node.is_open) {
              if (!_this.handleOpenFolder(node, node.element)) {
  ...
  var DragAndDropHandler = /*#__PURE__*/function () {
    ...
    _createClass(DragAndDropHandler, [{
      ...
      value: function mouseCapture(positionInfo) {
        var element = positionInfo.target;
  ...
  var BorderDropHint = /*#__PURE__*/function () {
    ...
    _createClass(BorderDropHint, [{
      ...
      value: function remove() {
        var _this$hint;
        (_this$hint = this.hint) === null || _this$hint === void 0 || _this$hint.remove();
      }
    }]);
