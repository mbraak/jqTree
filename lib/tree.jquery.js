...
var elementsRenderer_1 = __importDefault(require("./elementsRenderer"));
var dataLoader_1 = __importDefault(require("./dataLoader"));
var keyHandler_1 = __importDefault(require("./keyHandler"));
var mouse_widget_1 = __importDefault(require("./mouse.widget"));
var saveStateHandler_1 = __importDefault(require("./saveStateHandler"));
var scrollHandler_1 = __importDefault(require("./scrollHandler"));
var selectNodeHandler_1 = __importDefault(require("./selectNodeHandler"));
var simple_widget_1 = __importDefault(require("./simple.widget"));
...
var JqTreeWidget = /** @class */ (function (_super) {
    ...
    function JqTreeWidget() {
        ...
        _this.handleContextmenu = function (e) {
            var $div = jquery_1["default"](e.target).closest("ul.jqtree-tree .jqtree-element");
            if ($div.length) {
    ...
    */
    ...
    JqTreeWidget.prototype.getNodeByHtmlElement = function (element) {
        return this.getNode(jquery_1["default"](element));
    };
    ...
    JqTreeWidget.prototype.scrollToNode = function (node) {
        ...
        var nodeOffset = jquery_1["default"](node.element).offset();
    ...
    JqTreeWidget.prototype._triggerEvent = function (eventName, values) {
        var event = jquery_1["default"].Event(eventName, values);
    ...
    */
    ...
    JqTreeWidget.prototype._containsElement = function (element) {
        var node = this.getNode(jquery_1["default"](element));
    ...
    JqTreeWidget.prototype.getClickTarget = function (element) {
        var $target = jquery_1["default"](element);
