...
var _nodeElement = _interopRequireDefault(require("./nodeElement"));
var _folderElement = _interopRequireDefault(require("./nodeElement/folderElement"));
  ...
  _createClass(JqTreeWidget, [{
    ...
    */
    ...
    value: function closeNode(node, slideParam) {
      ...
      if (node.isFolder() || node.isEmptyFolder) {
        new _folderElement["default"](node, this).close(slide, this.options.animationSpeed);
        this.saveState();
      }
      return this.element;
    }
    ...
    value: function _openNode(node) {
      ...
      var doOpenNode = function doOpenNode(_node, _slide, _onFinished) {
        var folderElement = new _folderElement["default"](_node, _this3);
    ...
    */
    ...
    value: function _getNodeElementForNode(node) {
      if (node.isFolder()) {
        return new _folderElement["default"](node, this);
      } else {
        return new _nodeElement["default"](node, this);
      }
    }
  }, {
    key: "_getNodeElement",
