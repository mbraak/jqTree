...
beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, page.goto("http://localhost:8080/")];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
it("moves a node", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, testUtil_1.findTitleElement("Herrerasaurians").then(function (handle) {
                    return handle.boundingBox();
                })];
            case 1:
                fromRect = _a.sent();
                return [4 /*yield*/, testUtil_1.findTitleElement("Ornithischians").then(function (handle) {
                        return handle.boundingBox();
                    })];
            case 2:
                toRect = _a.sent();
                return [4 /*yield*/, page.mouse.move((fromRect === null || fromRect === void 0 ? void 0 : fromRect.x) || 0, (fromRect === null || fromRect === void 0 ? void 0 : fromRect.y) || 0)];
            case 3:
                _a.sent();
                return [4 /*yield*/, page.mouse.down()];
            case 4:
                _a.sent();
                return [4 /*yield*/, page.mouse.move((toRect === null || toRect === void 0 ? void 0 : toRect.x) || 0, (toRect === null || toRect === void 0 ? void 0 : toRect.y) || 0)];
            case 5:
                _a.sent();
