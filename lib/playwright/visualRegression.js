...
exports.getImagesOfEqualSize = exports.readPng = exports.matchScreenshot = void 0;
var fs_1 = require("fs");
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                expectedImagePath = path.join(__dirname, "screenshots/" + testName + ".png");
                if (!!fs_1.existsSync(expectedImagePath)) return [3 /*break*/, 3];
                return [4 /*yield*/, saveFile(expectedImagePath, screenshotBuffer)];
            case 2:
                _b.sent();
                return [2 /*return*/];
            case 3: return [4 /*yield*/, exports.readPng(expectedImagePath)];
            case 4:
                expectedImage = _b.sent();
                screenshot = pngjs_1.PNG.sync.read(screenshotBuffer);
                _a = exports.getImagesOfEqualSize(expectedImage, screenshot), adjustedExpectedImage = _a[0], adjustedScreenshot = _a[1];
                width = screenshot.width, height = screenshot.height;
                diff = new pngjs_1.PNG({ width: width, height: height });
                mismatchedPixels = pixelmatch(adjustedExpectedImage.data, adjustedScreenshot.data, diff.data, screenshot.width, screenshot.height, {});
...
exports.readPng = function (filePath) { return __awaiter(void 0, void 0, void 0, function () {
    var buffer;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
exports.getImagesOfEqualSize = function (image1, image2) {
