...
var _scrollParent = _interopRequireDefault(require("./scrollHandler/scrollParent"));
  ...
  _createClass(ScrollHandler, [{
    ...
    value: function getScrollParent() {
      if (!this.scrollParent) {
        this.scrollParent = (0, _scrollParent["default"])(this.treeWidget.$el, this.treeWidget.refreshHitAreas.bind(this.treeWidget));
      }
