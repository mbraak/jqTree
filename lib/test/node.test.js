...
describe("addAfter", () => {
  ...
  given("tree", () => new _node.Node().loadFromData(_exampleData.default));
...
describe("addChildAtPosition", () => {
  const given = (0, _givens.default)();
  given("child", () => new _node.Node("new"));
  given("node", () => new _node.Node("new").loadFromData(["child1", "child2"]));
  beforeEach(() => {
...
describe("addParent", () => {
  const given = (0, _givens.default)();
  given("node1", () => new _node.Node("node1"));
  given("tree", () => new _node.Node({}, true));
  beforeEach(() => {
...
describe("append", () => {
  const given = (0, _givens.default)();
  given("node", () => new _node.Node("node1"));
  it("appends a node", () => {
...
describe("constructor", () => {
  const given = (0, _givens.default)();
  given("node", () => given.params === undefined ? new _node.Node() : new _node.Node(given.params));
...
describe("getChildIndex", () => {
  const given = (0, _givens.default)();
  given("child2", () => new _node.Node("child2"));
  given("node", () => new _node.Node());
  beforeEach(() => {
  ...
  context("when a child doesn't exist", () => {
    it("returns -1", () => {
      const nonExistingChild = new _node.Node("non-existing");
...
describe("loadFromData", () => {
  it("creates a tree", () => {
    const tree = new _node.Node().loadFromData(_exampleData.default);
  ...
  it("sets isEmptyFolder to true for a node when it is has an empty children attribute", () => {
    ...
    const tree = new _node.Node().loadFromData(data);
