...
describe("tree.click", () => {
    ...
    it("fires tree.click", () => new Promise((done) => {
        given.$tree.on("tree.click", (e) => {
            const treeClickEvent = e;
...
describe("tree.contextmenu", () => {
    ...
    it("fires tree.contextmenu", () => new Promise((done) => {
        given.$tree.on("tree.contextmenu", (e) => {
            const treeClickEvent = e;
            expect(treeClickEvent.node).toBe(given.node1);
            done();
        });
...
describe("tree.dblclick", () => {
    ...
    it("fires tree.dblclick", () => new Promise((done) => {
        given.$tree.on("tree.dblclick", (e) => {
            const treeClickEvent = e;
            expect(treeClickEvent.node).toBe(given.node1);
            done();
        });
...
describe("tree.load_data", () => {
    ...
    context("when the tree is initialized with data", () => {
        it("fires tree.load_data", () => new Promise((resolve) => {
            given.$tree.on("tree.load_data", (e) => {
...
describe("tree.select", () => {
    ...
    context("when the node was selected", () => {
        ...
        it("fires tree.select with node is null", () => new Promise((done) => {
            given.$tree.on("tree.select", (e) => {
                const treeClickEvent = e;
