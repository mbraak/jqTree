...
describe("getNodeByHtmlElement", () => {
    const given = getGiven();
    given("htmlElement", () => screen.getByText("node1", { selector: ".jqtree-title" }));
    given("$tree", () => $("#tree1"));
    beforeEach(() => {
        given.$tree.tree({ data: exampleData });
    });
...
describe("loadData", () => {
    ...
    context("with a node parameter", () => {
        beforeEach(() => {
            given.$tree.tree("loadData", exampleData, given.$tree.tree("getNodeByNameMustExist", "initial1"));
        });
...
describe("loadDataFromUrl", () => {
    ...
    context("with url parameter", () => {
        it("loads the tree", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    context("without url parameter", () => {
        given("dataUrl", () => "/tree/");
        it("loads the data from dataUrl", () => __awaiter(void 0, void 0, void 0, function* () {
...
describe("openNode", () => {
    ...
    context("with onFinished parameter", () => {
        it("calls the function", () => new Promise((resolve) => given.$tree.tree("openNode", given.node1, (node) => resolve(expect(node).toBe(given.node1)))));
    });
});
...
describe("reload", () => {
    ...
    it("reloads the data from the server", () => __awaiter(void 0, void 0, void 0, function* () {
        expect(given.$tree).toHaveTreeStructure([
            expect.objectContaining({ name: "node2" }),
        ]);
    ...
    context("with a onFinished parameter", () => {
        it("calls onFinished", () => new Promise((resolve) => {
