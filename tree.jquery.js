...
(function() {
  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype._refreshElements = function(from_node) {
      ...
      escapeIfNecessary = (function(_this) {
      ...
      createUl = (function(_this) {
        return function(is_root_node) {
          var class_string;
          if (is_root_node) {
    ...
    VisibleNodeIterator.prototype.iterate = function() {
      ...
      _iterateNode = (function(_this) {
        return function(node, next_node) {
          var $element, child, children_length, i, must_iterate_inside, _i, _len, _ref, _results;
  ...
  GhostDropHint = (function() {
    function GhostDropHint(node, $element, position) {
      ...
      this.node = node;
      this.$ghost = $('<li class="jqtree-branch jqtree-ghost"><span class="jqtree-circle"></span><span class="jqtree-line"></span></li>');
      if (position === Position.AFTER) {
        this.moveAfter();
      } else if (position === Position.BEFORE) {
        this.moveBefore();
